# Mapping from slug to imageUrl
# Items with real images get the path, items without get ''
IMAGE_MAP = {
    ...
    # No image - use empty string
    'salted-pumpkin': '',
    'stir-fried-pork-bean-sprouts-vermicelli': '',
    'chinese-sauerkraut-glass-noodles': '',
    'west-lake-beef-minced-soup': '',
    'steamed-rice': '',
    'pork-cabbage-dumplings': '',
    'prawn-pork-chives-dumpling': '',
    'chicken-mushroom-dumpling': '',
    'steamed-pork-cabbage-dumplings': '',
    'steamed-dumplings-prawn-pork-chives': '',
    'steamed-chicken-dumplings': '',
    'steamed-beef-dumplings': '',
    'pork-meat-mini-shumai': '',
    'stir-fried-beef-rice': '',
    'sichuan-fish-fragrant-eggplant-rice': '',
    'spare-ribs-rice-noodle-pot': '',
    'marbled-beef-rice-noodle-pot': '',
    'fish-fillet-rice-noodle-pot': '',
    'braised-brisket-rice-noodle-pot': '',
    'crispy-wide-noodles-spicy-minced-pork': '',
    'numbing-spicy-pork-intestine-soup-noodles': '',
    'pork-mince-noodles': '',
    'braised-beef-brisket-soup-noodles': '',
    'spicy-beef-cold-noodles': '',
    'braised-beef-brisket-potato-noodles': '',
    'tomato-egg-tossed-noodles': '',
    'big-plate-chicken-noodles': '',
    'tomato-braised-brisket-soup-noodles': '',
    'spicy-brisket-soup-noodles': '',
    'tomato-fatty-beef-soup-noodles': '',
    'kung-pao-chicken-noodle': '',
    'bbq-noodles': '',
    'sour-spicy-fatty-beef-soup-noodles': '',
    'spicy-pork-rib-soup-noodles': '',
    'fire-breathing-beef-noodles': '',
    'inferno-fatty-beef-noodles': '',
    'fried-noodles-beef': '',
    'fried-noodles-vegetable': '',
    'fried-noodles-chicken': '',
    'fried-noodles-shredded-pork': '',
}
...
def replace_image_url(match):
    ...
    if slug in IMAGE_MAP:
        new_url = IMAGE_MAP[slug]
        return f"{before}'{new_url}'{after}"
    # If slug not in map, leave unchanged
    return match.group(0)

# Pattern: slug: 'SLUG', description: '...', price: X, imageUrl: 'ANYTHING', isAvailable
# We need to match each item's slug and imageUrl on the same line
pattern = r"(slug: '([^']+)'[^}]*?imageUrl: )'[^']*'(,)"

new_content = re.sub(pattern, replace_image_url, content)
