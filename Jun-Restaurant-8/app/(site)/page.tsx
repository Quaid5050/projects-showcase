      ...
      >
        ...
        <div className="glass-panel grid gap-6 rounded-[1.5rem] p-5 sm:p-6 md:grid-cols-2 md:gap-8 md:rounded-[2rem] md:p-10">
          <div>
            ...
            <h3 className="mt-2 font-display text-2xl text-rice-50 sm:text-3xl">Find us on St. Clair</h3>
          ...
          <div className="overflow-hidden rounded-2xl border border-white/10 bg-ocean-900/40">
            <iframe
              title="ONO Poké Bar St. Clair map"
              className="h-56 w-full sm:h-64 md:h-full"
              loading="lazy"
              referrerPolicy="no-referrer-when-downgrade"
              src="https://www.google.com/maps?q=1353+St+Clair+Ave+W+Toronto+ON+M6E+1C5&output=embed"
            />
          </div>
        </div>
        </section>
