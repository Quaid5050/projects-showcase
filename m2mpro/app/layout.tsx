...
export const metadata: Metadata = {
  title: "M2M Pro Cleaners — Professional Cleaning in Langley, BC",
  description: "Premium residential and commercial cleaning services in Langley, Surrey, Abbotsford, Vancouver & Lower Mainland.",
};
