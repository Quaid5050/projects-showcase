...
export default function Conditions() {
  ...
  const anchorId = useMemo(() => location.hash.replace(/^#/, '').trim() || undefined, [location.hash])
  ...
  return (
    <div className="relative overflow-hidden">
      ...
      <section className="border-b border-stone-200 bg-base-900/70 py-10">
          ...
          <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            <label className="relative block w-full lg:max-w-md">
              ...
              <input
                ...
                className="w-full rounded-full border border-stone-200 bg-white py-3 pl-11 pr-4 text-sm text-cream outline-none placeholder:text-muted/50 transition hover:border-orange/40 focus:border-orange/50 focus:ring-2 focus:ring-orange/22"
              />
            </label>
              ...
              return (
                <button
                  ...
                  className={`rounded-full border px-4 py-2 text-xs font-semibold uppercase tracking-wide transition ${
                    isOn
                      ? 'border-orange/55 bg-gradient-to-br from-orange/18 to-peach/35 text-orange shadow-sm ring-1 ring-orange/25'
                      : 'border-stone-200 bg-stone-50 text-muted hover:border-orange/35 hover:text-cream'
                  }`}
                >
      ...
      <section className="py-16 sm:py-24">
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-10">
            {filtered.length ? (
              <ConditionAccordion categories={filtered} anchorId={anchorId} />
            ) : (
              <AnimatedReveal className="surface-card p-8 text-center text-muted">
