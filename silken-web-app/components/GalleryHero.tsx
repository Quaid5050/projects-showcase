  ...
  return (
    ...
    >
      <div ref={bgRef} className="absolute inset-[-5%] will-change-transform">
        <Image
          src="/images/gallery/transform-2.jpeg"
          alt="Car interior transformations gallery"
          fill
          priority
      ...
      <div className="absolute left-1/3 top-1/2 -translate-y-1/2 h-72 w-72 rounded-full bg-gold-primary/10 blur-[110px] pointer-events-none" />
