      ...
      <div className="container" style={{padding:'50px 20px 24px'}}>
        <div className="footer-grid" style={{display:'grid',gridTemplateColumns:'repeat(4,1fr)',gap:32,marginBottom:40}}>
          ...
          <div>
            ...
            {[{t:'119 Riviera Blvd, Tower Isle, St. Mary, Jamaica',h:null},{t:'+1 (876) 268-9319',h:'tel:+18762689319'},{t:'info@sunsetretreatja.com',h:'mailto:info@sunsetretreatja.com'}].map((c,i)=>(
