...
export const metadata: Metadata = {
  title: {
    default: "Northbuilt Door & Dock | Southwestern Ontario",
    template: "%s | Northbuilt Door & Dock",
  },
  description:
    "Premium residential, commercial, and agricultural doors and dock equipment. Proudly serving Southwestern Ontario.",
  keywords: ["garage doors", "dock equipment", "Southwestern Ontario", "residential garage doors"],
};
