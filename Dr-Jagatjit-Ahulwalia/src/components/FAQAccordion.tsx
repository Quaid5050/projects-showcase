    ...
    <div className="space-y-3">
      {items.map((item) => {
        ...
        return (
          <div
            key={item.id}
            className="overflow-hidden rounded-2xl border border-white/10 bg-base-900/50 shadow-glass backdrop-blur-md transition hover:border-primary/25"
          >
            <h3>
              <button
                id={btnId}
                type="button"
                className="flex w-full items-center gap-4 px-5 py-4 text-left text-cream transition hover:bg-white/[0.04] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-[-2px] focus-visible:outline-primary"
